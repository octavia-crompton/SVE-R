...
Figure \ref{summary} summarizes the workflow of \code{dry.f}, which can be divided into main two steps: (1) initializing and (2) running the model.   The following subsections describe \code{dry.f} components in greater detail.
